...
var page = {
    ...
    about: function() {
        ...
        if($("#honor_gallery_slide").length > 0) {
            $("#honor_gallery_slide .slide_list").removeClass("load").slick({
                dots: false,
                infinite: false,
                speed: 300,
                swipe: false,
                slidesToShow: 1,
                adaptiveHeight: true,
                asNavFor: "#honor_gallery_slide .thumb_list"
            });
            
            $("#honor_gallery_slide .thumb_list").removeClass("load").slick({
                dots: false,
                infinite: false,
                speed: 300,
                swipe: false,
                ...
                slidesToShow: 1,
                variableWidth: true,
                asNavFor: "#honor_gallery_slide .slide_list"
            });
        }
    },
    park: function() {
    ...
    museum: function() {
        ...
        if($("#museum_detail_slide").length > 0) {
            $("#museum_detail_slide .detail_slide").append(function() {
                return $(this).html();
            }).removeClass("load");
            $("#museum_detail_slide .thumb_slide").append(function() {
                return $(this).html();
            }).removeClass("load");
            
            $("#museum_detail_slide .detail_slide").slick({
                fade: true,
                speed: 300,
                slidesToShow: 1,
                adaptiveHeight: true,
                dots: false,
                arrows: false,
                asNavFor: "#museum_detail_slide .thumb_slide"
            });
            $("#museum_detail_slide .thumb_slide").slick({
                speed: 300,
                focusOnSelect: true,
                slidesToShow: 5,
                dots: false,
                arrows: false,
                asNavFor: "#museum_detail_slide .detail_slide"
            });
            
            setTimeout(function() {
                //이미지 팝업
                var getDetailImg = $("#museum_detail_slide .detail_slide .slide_box img");
                getDetailImg.each(function() {
                    var getImg = $(this).attr("src");
                    $(this).magnificPopup({
                        removalDelay: 300,
                        mainClass: 'mfp-fade', 
                        items: { src:getImg }, type: "image" 
                    });
                });
                getDetailImg.elevateZoom({
