...
if ($_FILES["upload"]["size"] > 0 ){
    ...
    $uploadpath  = $_SERVER['DOCUMENT_ROOT']."/file/ckeditor/";
    $uploadsrc = $_SERVER['HTTP_HOST']."/file/ckeditor/";
...
echo '{"filename" : "'. iconv("UTF-8","EUC-KR",$savefilename) .'", "uploaded" : 1, "url":"'. $http.$uploadsrc . iconv("UTF-8","EUC-KR",$savefilename) .'"}';
